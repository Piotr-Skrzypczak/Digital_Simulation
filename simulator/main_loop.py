...
class MainLoop:
    ...
    def execute_process(self):
        ...
        while True:
            if self.processes[idx].service_time == 0:
                ...
                elif isinstance(self.processes[idx], Intensity):
                    self.processes[idx].change_lambda_intensity()
                    for bs in self.bses:
                        bs.intense = self.parameters.lambda_intensity * self.processes[idx].lambda_intensity_ratio
                    idx +=1
    ...
    def run(self, max_time):
        ...
        self.processes.append(Intensity())
        self.sort_proceses()
